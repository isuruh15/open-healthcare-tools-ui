export const articles = [
  {
    ...
    description: "How we implemented FHIR terminology server in Ballerina",
    imgPath:
      "https://images.unsplash.com/photo-1537944434965-cf4679d1a598?auto=format&fit=crop&w=800&h=300&q=60",
    link: "https://google.com",
  },
  {
    title: "FHIR Path evaluator",
    description: "How we implemented FHIR terminology",
    imgPath:
  ...
  {
    title: "FHIR APIs",
    //maximum char count is 30
    description: "Integrate with FHIR APIs",
    imgPath:
